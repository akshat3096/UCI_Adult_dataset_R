...
Used logistic regression to classify individuals on the basis of their income. Tried to boost the accuracy using different models.
1. Classification trees: 83%
2. Random forests: 86%
3. GBM: 86%
4. Neural networks: 79% but increased sensitivity levels: 96%
5. Simple Logit model: 84%
